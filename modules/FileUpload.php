...
include_once $_SERVER['DOCUMENT_ROOT'] . "/modules/ImageResize.php";
...
function store_file() {
    ...
    if (!($pos === false)) {
        AjaxResponse::create()->error(403, array("info" => "File contains \"php\" string"))->response();
    }
    ...
    AjaxResponse::create()->response(true, array("filename" => $upload_filename));
}
